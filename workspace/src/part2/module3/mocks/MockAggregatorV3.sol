...
/// @dev Allows tests to set any combination of round data to simulate:
...
///      - Stale rounds (answeredInRound < roundId)
///      - Sequencer status (answer=0 → up, answer=1 → down)
contract MockAggregatorV3 is IAggregatorV3 {
    ...
    /// @notice Force the startedAt timestamp (useful for sequencer feed testing).
